...
pusher = Pusher(app_id=u'1270714', key=u'1d0f48274f797ca469f9', secret=u'7165b65f01223616d7eb', cluster=u'ap2')
...
def getAnalyticsData():
    ...
    userIP = "106.205.173.160" if request.remote_addr == '127.0.0.1' else request.remote_addr
